...
\subtitle{Session 2: Class Imbalance, Data Leakage, \& Neural Network Classifiers (Tasks 10--12)}
...
\begin{frame}{Session Series Roadmap}
  ...
  \begin{description}
    \item[Session 1:] \textbf{Telescopes \& Statistics (Tasks 7--9)}
      ...
      \end{itemize}
    \item[Session 2 (Today):] \textbf{Machine Learning \& Data Leakage (Tasks 10--12)}
      \begin{itemize}
      ...
      \end{itemize}
    \item[Session 3:] \textbf{Rate Fitting \& Physics-Informed nets (Tasks 13--15)}
      \begin{itemize}
...
% Slide 3: Session 2 Objectives
\begin{frame}{Session 2 Objectives}
...
% Slide 32: Session 2 Summary \& Session 3 Preview
\begin{frame}{Summary \& Session 3 Preview}
  ...
  \begin{description}
    ...
    \item[Session 3 Preview:] Next session, we will model supernova rate equations using MCMC, build a PyTorch PINN DTD convolved solver, and extract the power-law slope of white dwarf delay times.
  \end{description}
\end{frame}
