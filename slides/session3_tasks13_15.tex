...
\subtitle{Session 3: Bayesian MCMC, PINN Convolutions, \& Delay Time Distributions (Tasks 13--15)}
...
% Slide 2: Session Series Roadmap
\begin{frame}{Session Series Roadmap}
...
% Slide 3: Session 3 Objectives
\begin{frame}{Session 3 Objectives}
...
% Slide 17: Reconstructing $\gamma$ via PyTorch Optimization
...
\begin{frame}{Summary of Phase 2}
  \begin{block}{Key Milestones Completed}
    \begin{itemize}
      \item **Session 1 (Tasks 7--9):** Applied observational selection filters (apparent magnitude cuts) to model Malmquist Bias, queried SDSS, and performed 1D/2D K-S tests.
      \item **Session 2 (Tasks 10--12):** Resolved class imbalance without data leakage, trained MLP classifiers, and analyzed feature importances.
      \item **Session 3 (Tasks 13--15):** Modeled physical supernova rate equations, mapped parameter uncertainties using MCMC, and reconstructed Delay Time Distributions via PyTorch convolved rate solvers.
    \end{itemize}
  \end{block}
