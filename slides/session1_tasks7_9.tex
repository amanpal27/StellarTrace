...
\subtitle{Session 1: Observational Selection \& Non-Parametric Statistics (Tasks 7--9)}
...
\begin{frame}{Session Series Roadmap}
  ...
  \end{block}
  \begin{description}
    \item[Session 1 (Today):] \textbf{Telescopes \& Statistics (Tasks 7--9)}
      \begin{itemize}
...
% Slide 3: Session 1 Objectives
\begin{frame}{Session 1 Objectives}
  \begin{itemize}
...
% Slide 25: Session 1 Summary \& Homework
\begin{frame}{Session 1 Summary \& Homework}
  ...
  \begin{description}
    ...
    \item[Session 2 Preview:] Next session, we will address class imbalances using SMOTE under strict train-test separation to prevent data leakage, and train our first Multi-Layer Perceptron classifier.
  \end{description}
\end{frame}
